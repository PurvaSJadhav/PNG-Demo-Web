...
const addSecurity = ({ vehicles = [], loading = false }) => {
    ...
    <div className="!flex !min-h-screen !font-sans !bg-[#F7F2E9]">
      ...
      <aside className="!w-64 !bg-[#c52c2d] !text-white !min-h-screen !p-5 !flex !flex-col !items-center !shadow-md !fixed">
        <div className="!flex !flex-col !items-center !mb-12 !mt-10">
          ...
          <h2 className="!text-2xl !font-semibold">JOHN DON</h2>
      ...
      <div className="!max-w-2xl !mx-auto !my-10 !p-8 !bg-white !rounded-lg !shadow-lg !ml-150">
        ...
        <form className="!space-y-6">
          ...
          {/* Weapon Licence No */}
          <div className="!flex !flex-col">
            <label className="!mb-1 !font-medium !text-gray-700">Weapon Licence No</label>
            <input
              type="text"
              name="weaponLicence"
              required
          ...
          {/* Weapon ID */}
          <div className="!flex !flex-col">
            <label className="!mb-1 !font-medium !text-gray-700">Weapon ID</label>
            <input
              type="text"
              name="weaponID"
              required
          ...
          {[
            ...
            <div key={fileInput.name} className="!flex !flex-col">
              <label className="!mb-1 !font-medium !text-gray-700">{fileInput.label}</label>
              <input
                type="file"
                name={fileInput.name}
